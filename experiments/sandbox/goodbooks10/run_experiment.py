...
model_config_mrf = {
    ...
    "model_specific": {
        ...
        # "threshold": 0.147,  # results in sparsity 2 % (for alpha=0.75)
        # "threshold": 0.23,  # results in sparsity 1 % (for alpha=0.75)
        "threshold": 0.35,  # results in sparsity 0.5 % (for alpha=0.75)
        "maxInColumn": 1000,
...
model_config_sansa = {
    ...
    "model_specific": {
        "l2": 125,  # same as EASE
        "target_density": 5e-4,  # of factor L and L_inv; also controls memory overhead in UMR
        "ainv_params": {
